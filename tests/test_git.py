...
class GitTestCase(TestCase):
    ...
    def test_git_describe(self):
        with mock.patch('utile.which', return_value=['/usr/bin/git']):
            with mock.patch('utile.Popen') as MockPopen:
    ...
    def test_pkg_info(self):
        with mock.patch('utile.which', return_value=[]):
            with mock.patch('os.path.exists', return_value=True):
                with mock.patch('utile.open', create=True) as mock_open:
